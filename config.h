...
static const int usealtbar          = 1;        /* Polybar patch: use non dwm bar */
static const char *altbarclass      = "Polybar";/* Polybar patch: alternate bar class name */
static const char *alttrayname      = "tray";   /* Polybar patch:Polybar tray instance name */
static const char *altbarcmd        = "$HOME/bar.sh"; /*Polybar patch: Alternate bar launch command */
...
//{ MODKEY,                     XK_F4,            spawn,          SHCMD(TERMINAL " -e pulsemixer; kill -44 $(pidof dwmblocks)") },
  { MODKEY,                     XK_F5,            spawn,          SHCMD(TERMINAL " -e pacmixer") },
